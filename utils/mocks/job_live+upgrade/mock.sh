...
# ./utils/mocks/job_live+upgrade/mock.sh --CASEDIR=https://invent.kde.org/tduck/os-autoinst-distri-kdelinux.git
...
# Download the previously success build image
